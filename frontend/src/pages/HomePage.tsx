    ...
    <div className="min-h-screen">
      <section className="pt-32 pb-24 px-4 text-center max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6 animate-slide-up">
          Build Your Resume<br /><span className="text-brand-600">in Minutes</span>
        </h1>

        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up">
          Describe your background in plain text or speak using your mic. Our AI generates a professional, ATS-ready resume instantly.
        </p>

        <div className="flex items-center justify-center gap-4 animate-slide-up">
          <Link to="/builder" className="btn-primary text-base px-8 py-3"><Wand2 size={18} /> Start Building Free</Link>
          <Link to="/saved" className="btn-secondary text-base px-8 py-3">View Saved</Link>
        </div>
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mb-14 max-w-xl mx-auto">A complete toolkit for building professional resumes, powered by AI.</p>
      ...
      <section className="py-20 px-4 text-center">
        ...
        <Link to="/builder" className="btn-primary text-base px-8 py-3"><Wand2 size={18} /> Build My Resume Now</Link>
      </section>
